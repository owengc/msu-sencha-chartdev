...
Ext.define('app.view.component.RangeSelector', {
    ...
    /*
      initialize - This function initializes the RangeSelector using values specified in the config object. SegmentedButton initialize function
	...
	outString+=Math.round(totalMinutes)+' min';
